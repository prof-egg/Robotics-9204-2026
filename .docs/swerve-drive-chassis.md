...
| - | :-: | :-: | :-: | :-: | :-: |
| Front Left | `false` | `false` | `359.3` | `11.75` | `11.75` |
| Front Right | `false` | `false` | `359.3` | `11.75` | `-11.75` |
| Back Left | `false` | `false` | `359.3` | `-11.75` | `11.75` |
| Back Right | `false` | `false` | `359.3` | `-11.75` | `-11.75` |
> [!NOTE]
